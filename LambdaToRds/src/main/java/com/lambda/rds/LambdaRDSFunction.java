...
public class LambdaRDSFunction implements RequestHandler<String, String> {

	public String handleRequest(String employeeId, Context context) {
	    ...
	    //Get employee Service bean
		 ...
		 //Make call to RDS
		 String emp =empService.getEmployee(Integer.parseInt(employeeId));
		 
		context.getLogger().log("Employee JSON: " + emp);
